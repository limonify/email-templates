...
export interface AnnouncementEmailProps extends Partial<Omit<EmailLayoutProps, 'children' | 'theme'>> {
  theme: EmailTheme
  subject?: string
  heading?: string
  description?: string
...
export const AnnouncementEmail: React.FC<AnnouncementEmailProps> = ({
  ...
  const resolvedDescription =
    description || `Hi ${userName}, we have an important announcement regarding ${appName}:`
