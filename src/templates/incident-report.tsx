...
export interface IncidentReportEmailProps extends Partial<Omit<EmailLayoutProps, 'children' | 'theme'>> {
  theme: EmailTheme
    ...
    >
      ...
      >
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <tbody>
            <tr>
              <td style={{ padding: '4px 0', fontSize: '12px', color: theme.mutedForeground }}>{statusLabel}</td>
              <td style={{ padding: '4px 0', fontSize: '12px', color: '#facc15', textAlign: 'right', fontWeight: '600' }}>{status}</td>
            </tr>
            <tr>
              <td style={{ padding: '4px 0', fontSize: '12px', color: theme.mutedForeground }}>{affectedLabel}</td>
              <td style={{ padding: '4px 0', fontSize: '12px', color: theme.foreground, textAlign: 'right', fontWeight: '500' }}>{affectedServices}</td>
            </tr>
          </tbody>
        </table>
      </div>
